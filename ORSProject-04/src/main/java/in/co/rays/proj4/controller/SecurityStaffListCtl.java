...
/**
 * SecurityStaffListCtl handles listing, searching, pagination and delete
 * operations for Security Staff.
 */

@WebServlet(name = "SecurityStaffListCtl", urlPatterns = { "/ctl/SecurityStaffListCtl" })
public class SecurityStaffListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    SecurityStaffBean deleteBean = new SecurityStaffBean();
                    ...
                    ServletUtility.setSuccessMessage("Security Staff deleted successfully", request);
    ...
    protected String getView() {
        return ORSView.SECURITY_STAFF_LIST_VIEW;
    }
}