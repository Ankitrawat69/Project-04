...
/**
 * EventModel provides CRUD and search operations for EventBean,
 * interacting with the {@code st_event} table via JDBC.
 * 
 * @author Ankit Rawat
 * @version 1.0
 */
public class EventModel {
    ...
    /**
     * Returns next primary key value for st_event table.
     */
    ...
    public void update(EventBean bean) throws ApplicationException, DuplicateRecordException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement(
                    "update st_event set event_code=?, event_name=?, organizer=?, event_date=?, "
    ...
    public EventBean findByEventCode(String code) throws ApplicationException {
        ...
        try {
            ...
            throw new ApplicationException("Exception in getting Event by Code");
        } finally {
            JDBCDataSource.closeConnection(conn);
        }
        return bean;
