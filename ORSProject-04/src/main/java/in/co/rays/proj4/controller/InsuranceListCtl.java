...
/**
 * InsuranceListCtl handles listing, searching, pagination and bulk delete
 * operations for Insurance entities.
 * 
 * @author Ankit Rawat
 * @version 1.0
 */
...
public class InsuranceListCtl extends BaseCtl {
    ...
    /**
     * Populates InsuranceBean for search.
     */
    @Override
    ...
    /**
     * Handles POST request (Search, Next, Previous, New, Delete, Reset, Back).
     */
    @Override
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    ServletUtility.setSuccessMessage(
                            "Insurance deleted successfully", request);
