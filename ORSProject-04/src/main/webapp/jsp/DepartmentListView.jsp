		...
		<form action="<%=ORSView.DEPARTMENT_LIST_CTL%>" method="post">
				...
				<tr>
					<td align="center">
						...
						<input type="text" name="departmentCode"
							...
							value="<%=ServletUtility.getParameter("departmentCode", request)%>">&emsp;

						<label><b>Department Name :</b></label>
						<input type="text" name="departmentName"
							placeholder="Enter Department Name"
							value="<%=ServletUtility.getParameter("departmentName", request)%>">&emsp;

						<input type="submit" name="operation"
							value="<%=DepartmentListCtl.OP_SEARCH%>">
						&nbsp;
						<input type="submit" name="operation"
			...
			<table border="1" style="width: 100%; border: groove;">
				...
				<tr>
					...
					<td style="text-align: center;"><%=bean.getDepartmentCode()%></td>
			...
			<table style="width: 100%">
				<tr>
					...
					<td align="center" style="width: 25%">
						<input type="submit" name="operation"
							value="<%=DepartmentListCtl.OP_NEW%>">
					</td>

					<td align="center" style="width: 25%">
						<input type="submit" name="operation"
							value="<%=DepartmentListCtl.OP_DELETE%>">
					</td>
			...
			<table>
				<tr>
					<td align="right">
						<input type="submit" name="operation"
							value="<%=DepartmentListCtl.OP_BACK%>">
					</td>
				</tr>
			</table>
			<%
